...
func main() {
	...
	f, err := os.Create("internal/registry/internal/ipv6/bootstrap_generated.go")
	...
	log.Printf("Wrote IPv6 bootstrap data to internal/registry/internal/ipv6/bootstrap_generated.go")
}
